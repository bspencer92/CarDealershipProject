  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p class="lead text-muted">Click a button to see new or used cars.</p>
        <p>
          <a href="/index-new" class="btn btn-primary my-2">New Cars!</a>
      ...
      <c:forEach items="${usedcarinventory}" var="usedcarInventory">   
        <div class="col">
          <div class="card shadow-sm">
            <img src="${usedcarInventory.imagePath}" alt="Image Not Found" width="100%" height="225" />
            <div class="card-body">
